...
private:
    ...
    static constexpr bool isNonRiched = std::is_invocable<decltype(func), RdKafka::Message &, Source_Shipper<result_t> &, tuple_t &>::value;
    static constexpr bool isRiched = std::is_invocable<decltype(func), RdKafka::Message &, Source_Shipper<result_t> &, tuple_t &, RuntimeContext &>::value;
