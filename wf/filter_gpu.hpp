...
#endif
        // if (batch_tobe_sent == nullptr) {
        //    std::cout << "Stateful_FILTERGPU_Kernel [input->num_dist_keys: " << input->num_dist_keys << ", num_blocks: " << num_blocks << ", threads per block: " << threads_per_block << ", num_active_thread_per_warp: " << num_active_thread_per_warp << "]" << std::endl;
        // }
