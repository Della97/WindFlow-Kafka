...
#ifndef SPIKEDETECTION_LIGHT_SOURCE1_HPP
#define SPIKEDETECTION_LIGHT_SOURCE1_HPP
...
extern atomic<long> source1_arrived_tuple;                   // total number of tuples sent by all the sources
extern atomic<long> source1_sent_tuple;                   // total number of tuples sent by all the sources
...
public:
// Constructor
    Kafka_Source1_Functor(const unsigned long _app_start_time,
                        const int _rate):
