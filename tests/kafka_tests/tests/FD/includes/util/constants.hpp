...
const string _model_file = "/home/dbmatteo/git/WindFlow-Kafka/Datasets/FD/model.txt";
const string _input_file = "/home/dbmatteo/git/WindFlow-Kafka/Datasets/FD/credit-card.dat";
