...
const string _model_file = "/home/della/git/WindFlow-Kafka/Datasets/FD/model.txt";
const string _input_file = "/home/della/git/WindFlow-Kafka/Datasets/FD/credit-card.dat";
